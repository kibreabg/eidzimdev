...
class com.fusionmaps.maps.SwedenMap extends Map {
	...
	*/
	public function feedEntities() {
		...
		super.addEntity("05", "I", "I", "Gotland");
		super.addEntity("06", "N", "N", "Halland");
		super.addEntity("07", "Z", "Z", "Jämtland");
		super.addEntity("08", "F", "F", "Jönköping");
		super.addEntity("12", "G", "G", "Kronoberg");
		super.addEntity("14", "BD", "BD", "Norrbotten");
		...
		super.addEntity("26", "AB", "AB", "Stockholm");
