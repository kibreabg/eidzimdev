...
$this->Image('../img/kemrilogo.jpg',140,9);	// Logo
	...
	$this->Ln(39);	
 	...
 	//$this->SetTextColor(204,204,204);
			...
			$this->Cell(140,10,sprintf("SUMMARY OF KITS USED BETWEEN ". $weekstartdatee . " & ".$weekenddatee),0,0,'C');	// Title
...
$WEEKLY= weeklykitsused($labss,$weekstartdate,$weekenddate);
$TESTS=totalweeklytests($labss,$weekstartdate,$weekenddate);
$wasted=weeklykitswasted($labss,$weekstartdate,$weekenddate);
...
$title= $weekstartdatee." - ".$weekenddatee ." KITS USED SUMMARY REPORT ".".pdf";
$F="I";
$pdf->Output($title,$F);?>
?>