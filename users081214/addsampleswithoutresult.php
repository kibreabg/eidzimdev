    ...
    if ($errflag) {
        ...
        if ($d == 0) {
            ...
            if ($mother && $patient && $sample) { //check if all records entered
                ...
                $st = "Sample " . $pid . " Successfully Added, in Batch " . $BatchNo;
                echo '<script type="text/javascript">';
                echo "window.location.href='addsampleswithoutresult.php?p=$st&q=$fcode&r=$province&z=$district&view=1&labid={$_GET['labid']}'";
                echo '</script>';
            } else {
                $st = "Sample Save Failed, try again ";
            }
...
<div class="section">
    ...
    <div class="xtop">
        ...
        <form id="customForm" method="get" action="addsampleswithoutresult.php">
                    ...
                    <td colspan="6">
                        <table border="1" style="border-color:#CCCCCC">
                            <tr>    
                                ...
                                <td>
                                    <strong>Rejected</strong>&nbsp;&nbsp;<input type="checkbox" id="reject" name="reject" value="2" /><br />
