...
$updateprinted=mysql_query("update samples set printed=1 where ID='$samplecode'") or die(mysql_error('1'));
...
extract($samples);	
/*....
$patientid = $samplecode;*/

//echo $samplecode.''.$patientid	;
...
$facility=GetFacilityCode($batchno,$lab);
...
<table style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:11px">
	  ...
	  <th colspan="7" style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; font-size:18px">HIV DNA PCR LABORATORY RESULT FORM</th>
	   ...
	   <tr>
		...
		<td colspan="" ><?php echo $provname;?></td>
		<?php 
		$provinfo = GetProvInfo($provid);
		extract($provinfo);
		?>
		<td><strong>Province Code</strong></td>
		<td colspan="" style="border-right:inset; border-right-color:#CCCCCC"><?php echo $ID;?></td>
		...
		//extract($pinfo);
		?>
        <td colspan="2" ><?php echo '<strong>Year &nbsp;</strong>'.$requestno_year.'&nbsp;&nbsp;<strong>No &nbsp;</strong>'.$requestno_no; ?></td>
	   ...
	   <tr>
		...
		<td style="border-right:inset; border-right-color:#CCCCCC"><?php echo $facilitycode;?></td>
  </tr>
		...
		if ($testedbefore == 1) 	 {$testedbefore = "Yes";}
		else if ($testedbefore == 2) {$testedbefore = "No";}
		else if ($testedbefore == 3) {$testedbefore = "Unk";}
		else {$testedbefore = "";}
		
		if ($onart == 1) 	 {$onart = "Yes";}
		else if ($onart == 2) {$onart = "No";}
		else if ($onart == 3) {$onart = "Unk";}
		else  {$onart = "";}
		...
		if ($receivearv == 1) 	 {$receivearv = "Yes";}
		else if ($receivearv == 2) {$receivearv = "No";}
		else if ($receivearv == 3) {$receivearv = "Unk";}
		else {$receivearv = "";}
		
		//mother pmtct intervention
		$art=GetMotherProphylaxis($ID);
		
		if ($delivery == 1) 	 {$delivery = "Caesarean";}
		else if ($delivery == 2) {$delivery = "Vaginal";}
		else if ($delivery == 3) {$delivery = "Unknown";}
		else  {$delivery = "";}
		?>	
	...
	<th height="10" colspan="8" style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">&nbsp;</th>
		...
		if ($infantarv == 1) 	 {$infantarv = "Yes";}
		else if ($infantarv == 2) {$infantarv = "No";}
		else if ($infantarv == 3) {$infantarv = "Unk";}
		else {$infantarv = "";}
		...
		<tr >
			...
			if ($testedbefore != '1')
			{
				...
				?>
					...
					<td ><?php echo //$originalpatientno; 
					'<small><strong>Year </strong>'.$patientinfo['originalrequestno_year'].' <strong>No</strong> '.$patientinfo['originalrequestno_no'].'</small>'?></td>
				<?php
				}
			}
			?>
		...
		<tr >
           ...
           <tr >
        	...
        	<td colspan="7" >&nbsp;</td>
			      ...
			      <th style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">Entry Point</th><td><?php echo $entry; ?></td><th style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">Reasons for DNA / PCR Test</th><td colspan="3" ><?php $test_reason = GetTestReason($test_reason);
									echo $test_reason; ?></td>
	...
	<!--	<tr><td>&nbsp;</td></tr><tr><td>&nbsp;</td></tr>-->
			              ...
			              <th colspan="8" style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; font-size:16px">********* &nbsp;<?php echo strtoupper($labname);?>&nbsp;LABORATORY  INFORMATION &nbsp;&nbsp;************ </th>
			<tr >
        ...
        <td colspan="2" ><span style="font-weight: bold">Date Received  </span></td>
                    ...
                    <td ><?php 
					if ($receivedstatus == 0) {$receivedstatus = '[No Status Selected]';}
					else
					{
					...
					$reviewer=GetUserFullnames($rejectedby);
        ...
        <td><span style="font-weight: bold">No of Spots </span></td>
				...
				<tr >
					...
					<td ><h2><?php echo $samplecode; ?></h2></td>	
				</tr>
				<tr><td>&nbsp;</td></tr><tr><td colspan="2"><span style="font-weight: bold">Rejected Reason</span></td><td><?php echo $rejectedreason; ?></td>
				</tr>
				<tr><td>&nbsp;</td></tr>
				...
				<TR>
					...
					<td style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; font-size:18px"><strong><?php echo ucwords('Please Send another Sample'); ?></strong></td>
<td colspan="2"  style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; ; font-size:18px"><span style="font-weight: bold"><?php echo strtoupper('Approved By');?></span></td>
					
					<td colspan="3" style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; font-size:18px"><strong><?php echo ucwords($reviewer); ?></strong></td>
				</TR>
			<?php 
			//}?>
      </table>
