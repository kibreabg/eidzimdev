...
function select(a) {
    ...
    for (i=0; i<theForm.elements.length; i++) {
		...
		<div  class="section">
		<div class="section-title">ALL RETESTED SAMPLES [ 1st & 2nd Run ]</div>
		
		<tr >
            <td height="24"  colspan="6">Click on Sample to view its Retest History, <br /></td>
		  </tr>
		<div class="xtop">

   <?php
   echo " All Retested Samples.".'<strong>'.GetTotalRepeatParentSamples($labss).'</strong>'; 
...
<tr><th>No</th><th>Patient ID</th><th>Facility</th><th>Sex</th><th>Age (mths)</th><th>Infant Prophylaxis</th><th>Date Collected</th><th>Spots</th><th>HIV Status</th><th>PMTCT Intervention</th><th>Feeding Type</th><th>Entry Point</th><th>Result</th><th>Task</th></tr>';
		...
		$No=$No+1;
			...
			echo "<tr class='even'>
	<td >$No</td>
	<td ><a href=\"retest_details.php" ."?ID=$ID" . "\" title='Click to view sample details'>$patient</a></td>
			<td >$facilityname </td>
			<td >$pgender </td>
			<td >$pAge</td>
	...
	<td ><a href=\"retest_details.php" ."?ID=$ID" . "\" title='Click to view Reets history of this sample'>View ReTest History</a> 
</td>
...
echo  '<strong>'.' <font color="#666600">'.'No Sample(s) Retested'.'</strong>'.' </font>';
