...
$this->Image('../img/kemrilogo.jpg',140,9);	// Logo
	...
	$this->Ln(39);	
 	...
 	//$this->SetTextColor(204,204,204);
			...
			$this->Cell(140,10,sprintf("SUMMARY OF KITS USED IN ". strtoupper($yearly)),0,0,'C');	// Title
...
$WEEKLY= yearlykitsused($labss,$yearly);
$TESTS=totalyearlytests($labss,$yearly);
$wasted=yearlykitswasted($labss,$weekstartdate,$weekenddate);
