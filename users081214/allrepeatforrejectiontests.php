...
function select(a) {
    ...
    for (i=0; i<theForm.elements.length; i++) {
		...
		<div  class="section">
		<div class="section-title">ALL REPEAT FOR REJECTION SAMPLES</div>
   ...
   <?php
   echo " Total Samples.".'<strong>'.GetTotalRepeatforRejection($labss).'</strong>'; 
...
<tr><th>No</th><th>Patient ID</th><th>Facility</th><th>Sex</th><th>Age (mths)</th><th>Infant Prophylaxis</th><th>Date Collected</th><th>Spots</th><th>HIV Status</th><th>PMTCT Intervention</th><th>Feeding Type</th><th>Entry Point</th><th>Result</th><th>Task</th></tr>';
	...
	<td ><a href=\"repeatforrejection_details.php" ."?ID=$patient" . "\" title='Click to view  history of this sample'>View  History</a> 
</td>
...
echo  '<strong>'.' <font color="#666600">'.'No Repeat Sample(s) for Rejection'.'</strong>'.' </font>';
