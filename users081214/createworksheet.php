...
<div class="section">
    ...
    <div class="xtop">
        ...
        $qury = "SELECT
                  ...
                  ORDER BY
                    l.priority ASC, isnull ASC, s.nmrlstampno ASC, s.datereceived ASC LIMIT 0,{$_GET['limit']}";
        ...
        if ($no == $_GET['limit']) {
                ...
                <table  border="0" class="data-table">
                    ...
                    <tr>
                        ...
                        while (list($ID, $nmrlstampno, $patientid, $patient) = mysql_fetch_array($result)) {
                            ...
                            echo "<td width='230px'>
	  		NMRL Stamp No: <strong>$nmstampno</strong><br>  
			...
			<div align='center'>
	 		<img src='html/image.php?code=code128&o=2&dpi=50&t=50&r=1&rot=0&text=$ID&f1=Arial.ttf&f2=6&a1=&a2=B&a3='  /> 
			</div></p></td>";
