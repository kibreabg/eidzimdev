...
//translate the quota  values to text
if ($quarterly ==1)
{
$quota="JAN-MAR";
}
...
$labss = $_SESSION['lab'];
$rejected=periodicrejectedsamples($labss,$quarterly,$quarteryear);
...
$quota="OCT-DEC";
	...
	$this->SetFont('Arial','B',14);			// Arial bold 15
			...
			// set parameters
					$this->Cell($offset2);
$this->Image('../img/zimlogoxm.jpg',140,9);	// Logo
...
$this->Cell(140,10,sprintf("SUMMARY OF TESTS DONE IN QUARTER ". strtoupper($quarterly)." - ".$quota ." ,".$quarteryear),0,0,'C');	// Title
...
function Footer()
{
	...
	$this->SetFont('Arial','B',8);		// Arial italic 8
		...
		$this->Cell(100,10,'© NATIONAL MICROBIOLOGY REFERENCE LABORATORY ',0,0, 'C');
...
$title=  "QUARTER ".strtoupper($quarterly)." - ".$quota." ,".$quarteryear ." TESTS SUMMARY REPORT ".".pdf";
$F="I";
$pdf->Output($title,$F);?>
?>