...
$rs = mysql_query( "CALL Getinfantprophpositivitycount($profid,$mwaka,$mwezi,1, @numtests)" );
...
$rs2 = mysql_query( "CALL Getinfantprophpositivitycount($profid,$mwaka,$mwezi,2, @numtests)" );
