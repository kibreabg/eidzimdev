...
$this->Image('../img/kemrilogo.jpg',140,9);	// Logo
	...
	$this->Ln(39);	
 	...
 	//$this->SetTextColor(204,204,204);
			...
			$this->Cell(140,10,sprintf("SUMMARY OF KITS USED IN ". strtoupper($month) . " , ".$monthyear),0,0,'C');	// Title
...
$WEEKLY= monthlykitsused($labss,$monthly,$monthyear);
$TESTS=totalmonthlytests($labss,$monthly,$monthyear);
$wasted=monthlykitswasted($labss,$weekstartdate,$weekenddate);
...
$title= "SUMMARY OF KITS USED IN ". $month . " , ".$monthyear.".pdf";
$F="I";
$pdf->Output($title,$F);?>
