...
$currentdate = date('d-M-Y');
		...
		$query = " SELECT f.ID,f.facilitycode,f.name,f.district,f.ftype,f.telephone,f.telephone2,f.ContactEmail,f.contactperson, f.imei, f.pass FROM facilitys f, districts d WHERE 1 = Case When '$provid' = '' Then 1  When '$provid' = d.province Then 1  END and 1 = Case When '$fcode' = '' Then 1  When '$fcode' = f.ID Then 1  END and 1 = Case When '$district' = '' Then 1  When '$district' = f.district Then 1  END and f.district = d.ID AND f.flag = 1 AND f.iseid='Yes' ORDER BY f.name ASC ";
...
{		
		...
		//display normal view
		echo "<table border=0>
		<tr><td colspan='12'><center><h2>EID FACILITIES LIST <small>as at $currentdate</small></h2></center></td></tr>
