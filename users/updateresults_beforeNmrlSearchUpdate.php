...
<html>
    ...
    <div  class="section">
        ...
        <form action="" method="post" id="customForm">
            <table width="1000" class="data-table" border="0">
                <tr class="even">
                    ...
                    <td width="179">
                        <span class="style7">
                            ...
                            <input name='serialno' type='hidden' id='serialno' value='<?php echo $ID; ?>'  style='width:174px'/> 
                        </span>
                    </td>
                    <td width="121" class="comment style1 style4" >Date Created </td>
                    <td width="22" class="comment">
                        <span class="style5">
                            <?php echo $datecreated; //get  date created ?>
                        </span>
                    </td>
                ...
                <tr class="even">
                    ...
                    <td width="207">
                        <span class="style7">
                            <span class="style1">
                                <?php echo $worksheetno; ?></span>
                            <input name='work' type='hidden' id='work' value='<?php echo $worksheetno; ?>'  style='width:174px'/>
                        </span>
                    </td>
                ...
                <tr class="even">
                    ...
                    <td width="207">
                        <div>
                            <input id="daterun" type="text" name="daterun" class="text"  size="26" />
                            <span id="daterunInfo"></span>
                        </div>
                        <div id="daterun"></div>
                    </td>
                ...
                <tr>
                    ...
                    $qury = "SELECT
                              ...
                              WHERE
                                l.withresult != 1 AND s.lab = l.id and worksheet = '$wno'
                              ORDER BY
                    ...
                    while (list($ID, $patient) = mysql_fetch_array($result)) {
                        ...
                        <td  height="50" width="145px">
                            Request No: <strong><?php echo $patient; ?></strong>
                ...
                <tr class='even'>
                    <td colspan='13' style="text-align: center;">
                        <input type='submit' name='submit' value='Update Results' class='button'>
                    </td>
                </tr>	
            </table>
        </form>
