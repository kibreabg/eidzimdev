...
<table style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px">
    ...
    <form name="fiform" method="get" action="dispatchedsummerylist.php?view=1">
    <table>
    <tr>
      <td>District<br/>
      <?php $accountquery = "SELECT ID,name FROM districts ORDER BY name ASC";
...
<select id='printed' name='printed'>
  ...
  <option value="0">Not Printed</option>
    ...
    <tr>
      <td>&nbsp;<button class="print">Print</button></td>
      <td>
...
{
$query = "SELECT ID as 'labcode',nmrlstampno,batchno,patient,facility,datereceived,datetested,datemodified,result,datedispatched,datereleased,printed,nmrlstampno,Smssent,NoofSmsSent,patientid  FROM samples where 1=Case When '$dit'= '' Then 1 When '$dit'= (select district From facilitys Where facilitys.ID=samples.facility LIMIT 1) Then 1 End and 1 = Case When '$sfd' = '' Then 1  When '$sfd' = samples.datedispatched Then 1  END and 1 = Case When '$p' = '' Then 1  When '$p' = samples.printed Then 1  END and 1 = Case When '$f' = '' Then 1  When '$f' = samples.facility Then 1  END and samples.lab='$labss' AND  samples.BatchComplete=1 and samples.Flag=1 and approved = 1  and resultprinted=1	ORDER BY datedispatched DESC LIMIT $offset, $rowsPerPage";
		//echo $query;	
}
else
{
...
{ ?>
	<div class="print_div">
	<?php
// print the districts info in table<th>Lab #</th><th>NMRL No</th><th>Batch No</th><th>Date Received</th><th>Date Tested </th><th>Date Updated </th><th> Result</th><th>Date Released </th><th>TAT</th><th>Printed </th><th>SMS sent</th>

echo '<table border="0"   class="data-table">
 <tr style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px"><th>Request No</th><th> Patient Name</th><th>Facility</th><th>Province</th><th>Date Dispatched </th>'.$showtask.'</tr>';//<th>No. of SMS sent</th>
...
<?php
  ...
  <tr>
    <td colspan="3" align="center"><p>Acknowledgement of Receipt </p>
      <p>&nbsp;</p>
      <p><br />
      </p></td>
  </tr>
  ...
  <tr>
    ...
    <td align="center">&nbsp;</td>
    <td align="center"  width="30%">Full Name</td>
  </tr>
  <tr>
    <td colspan="3"></td>
  </tr>
  ...
  <tr>
    <td colspan="3">Date Recieved</td>
  </tr>
<tr>
    <td colspan="3" align="center"><p><font size = "5">Please sign and return with the next batch of samples to NMRL this acknowledgment of receipt </font></p> </td>
  </tr>
</table>
