    ...
    <div class="xtop">
        ...
        <table>
            <tr>
			   ...
			   WHERE samples.lab='$labss' AND samples.BatchComplete = 1 and datedispatched = '' and printed = 0 and receivedstatus = 1 and approved = 1 and flag = 1 and repeatt=0";
...
//query database for all districts
            $query = "SELECT   ID, batchno, patient, facility, datereceived, datetested, datemodified, result, datereleased
                      FROM     samples
                      WHERE    samples.BatchComplete = 1 AND samples.resultprinted = 0 AND samples.Flag = 1 AND lab = '{$labss}' AND approved = 1 and  repeatt=0
