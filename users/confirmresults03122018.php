        ...
        if ($paroid > 0) {
            ...
            if (($noofretests == 2) && ($secondduplicateresult > 0)) {
                ...
                if ($testresultID == 6) {
                    ...
                    //The repeat is now Negative so save a complete batch
                    $repeatresults = mysql_query("UPDATE samples SET repeatt = 0 , inputcomplete = 1 , approved = 1, BatchComplete = 2 
                                                  WHERE (ID='$labcode[$a]')") or die(mysql_error());
