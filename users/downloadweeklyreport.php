...
$qury = "SELECT * FROM samples s, facilitys f WHERE s.datereceived BETWEEN '$startdate' AND '$enddate' AND s.flag = 1 AND s.facility = f.ID AND f.lab = '$labss' AND  s.repeatt=0 ORDER BY s.datereceived DESC ";
