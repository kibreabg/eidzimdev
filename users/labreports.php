...
if ($_REQUEST['provincereport']) {
    ...
    echo '</script>';
    exit();
} else if ($_REQUEST['weeklyreportUpdated']) {
    //get the weekly report variables
    $weekenddate = $_GET['weekenddate'];
    $weekstartdate = $_GET['weekstartdate'];

    echo '<script type="text/javascript">';
    echo "window.location.href='weeklylabreportupdated.php?view=1&weekenddate=$weekenddate&weekstartdate=$weekstartdate'";
    echo '</script>';
    exit();
        ...
        <form id="customForm" method="get" action="" target="_blank" >
            <table  border="1" style="border-color:#CCCCCC; border-right-color:#FFFFFF"><!--border="1" style="border-color:#CCCCCC" -->
                ...
                <tr>
                    ...
                    <td width="205">
                        <select style="width:200px"  id='cat' name="cat">
                            <script>
...
//$myCalendar->autoSubmit(true, "form1");
                ...
                <tr>
                    ...
                    <td>
                        <input name="weeklyreports" type="submit" value="Summary" size="2" class="button"/>	   <input name="weeklyreport" type="submit" value="Detailed" size="2" class="button"/>
                        <input name="weeklyreportUpdated" type="submit" value="Updated Detailed" size="2" class="button"/><!--|  <input name="kitweeklyreport" type="submit" value="Generate Kit Used Report" size="2" class="button"/>	 -->   
                    </td>
                </tr>
