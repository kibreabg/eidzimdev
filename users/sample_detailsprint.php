...
$facility = GetFacilityCodeByID($batchno, $sampleID); //Get the Facility code using the sample ID rather than using the user specific lab ID.
    ...
    <body onLoad="JavaScript:window.print();">
        ...
        <table style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:11px">
            ...
            <td><div align="center"><img src="../img/zimlogo.jpg" alt="" /></div></td> -->
                <th colspan="7"
                    style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; font-size:18px">
                    NATIONAL MICROBIOLOGY REFERENCE LABORATORY <br><br>HIV DNA PCR LABORATORY RESULT FORM</th>
                <td
                    style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; font-size:18px">
                    <div align="center"><img src="../img/lab_logo.png" alt="" /></div>
                </td>
            </tr>
            <tr>
                <td><strong>Province Name</strong></td>
                <td colspan="">
                    <?php echo strtoupper($provname); ?>
                </td>
                <?php
...
?>
                ...
                <input name="sampleid" type="hidden" class="text"
                    value="<?php echo $requestno_year . $requestno_no; ?>" />
...
?>
                ...
                <?php $pinfo = GetPatientInfo($patient)?>
                <td colspan="4">
            ...
            <tr>
                ...
                <td>
                    <?php echo $facilityname; ?>&nbsp;</td>

                <td><strong>Hospital Code</strong></td>
                <td style="border-right:inset; border-right-color:#CCCCCC">
                    <?php echo $facilitycode; ?>
                </td>
            </tr>
            <!--<tr ><td colspan="7">&nbsp;</td></tr> -->
            <th height="10" colspan="8"
                style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">&nbsp;</th>
            <?php
...
echo $pAge.$agetype; */?></td>
            ...
            <th colspan="2"
                style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; border-right:inset; border-right-color:#CCCCCC">
                INFANT PROPHYLAXIS</th>
            <th colspan="2"
                style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; border-right:inset; border-right-color:#CCCCCC">
                MOTHER PMTCT Prophylaxis</th>
            <th colspan="5" style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">
                Infant Testing (Check Child Health Card)</th>
            <?php
            //get all patient infor for use
            ...
            <tr>
                ...
                <td rowspan="3" style="border-right:inset; border-right-color:#CCCCCC">
                    <?php echo $testedbefore; ?>
                </td>
...
if ($testedbefore != '1') {
    if ($testtype == 'DNA PCR') {
        ?>
                <td><span style="font-weight: bold"><small>If DNA PCR, original patient Lab Request No </small></span>
                </td>
                <td>
                    <?php
...
?>
            ...
            <td colspan="8" style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">
                <strong>Infant Feeding </strong></td>
            <tr>
                <td colspan="2"><strong>Infant breastfed in the last 6 weeks  </strong> </td>
                <td>
                    <?php echo $breastfeeding; ?>
                </td>
            ...
            <th style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">Entry Point</th>
            <td>
                <?php echo $entry; ?>
            </td>
            <th style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">Reasons for DNA
                / PCR Test</th>
            <td colspan="3">
                <?php
...
?>
            ...
            <th colspan="8"
                style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; font-size:16px">
                ********* &nbsp;
                <?php echo strtoupper($labname); ?>&nbsp;LABORATORY INFORMATION &nbsp;&nbsp;************
            </th>
            <tr>
                ...
                <td>
                    <?php
                        echo "<b>[" . GetRejectedReason($rejectedreason) . "]</b>";
                    ?>
                </td>
            </tr>
            <!--<tr >
...
if ($result != 0) {
    ...
    ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo $datedispatched; ?>
                </td>
            </tr>


            <tr>
                <td colspan="4"><span style="font-weight: bold">Dispatch Comments : DBS SAMPLE VALID </span></td>
                <td colspan="3"><span style="font-weight: bold">Platform</span></td>
            </tr>
            <tr>
                <td colspan="4">
                    <?php echo $DispatchComments; ?>
                </td>
                <td colspan="3">Roche Ampliprep</td>
            </tr>
            ...
            <tr>
                <td colspan="2"
                    style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; ; font-size:18px">
                    <span style="font-weight: bold"><?php echo strtoupper('Test Result'); ?></span></td>
                <?php
$result = GetResultType($result);
    ?>
                <td
                    style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; font-size:18px">
                    <strong><u><?php echo strtoupper($result); ?></u></strong></td>
                <td colspan="2"
                    style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; ; font-size:10px">
                    <span style="font-weight: bold"><?php echo strtoupper('Approved By'); ?></span></td>

                <td colspan="3"
                    style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; font-size:10px">
                    <strong><?php echo ucwords($reviewer); ?></strong></td>
            </tr>
            <tr>
                <td colspan="8"
                    style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; ; font-size:18px; text-align: center;">
                    <span style="font-weight: bold"><b>Interpretation of Results</b></span></td>
            </tr>
            <tr>
                <td colspan="8" style="font-size: 13px;"><span style="font-weight: bold">Negative: </span><span>It means
                        there is no viral Nucleic acid (DNA or free proviral RNA) detected</span></td>
            </tr>
            <tr>
                <td colspan="8" style="font-size: 13px;"><span style="font-weight: bold">Positive: </span><span>It means
                        viral DNA or free proviral RNA was detected</span></td>
            </tr>
            <?php }
?>
        </table>
