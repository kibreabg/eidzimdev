 ...
 <!--<th colspan="4">FACILITY INFORMATION</th> -->
     <!--<tr><td colspan="7"><div align="center"><img src="../img/zimlogoxm.jpg" alt="" /></div></td></tr> -->
            ...
            <td><div align="center"><img src="../img/zimlogo.jpg" alt="" /></div></td> -->
                <th colspan="7" style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; font-size:18px">NATIONAL MICROBIOLOGY REFERENCE LABORATORY <br><br>HIV DNA PCR LABORATORY RESULT FORM</th>
...
<td><span style="font-weight: bold">No of Spots </span></td>
        ...
        if ($result != 0) {
			...
			<tr>
			<td colspan="4"><?php echo $DispatchComments; ?></td>
            ...
            <tr>
                <td colspan="8" style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2; ; font-size:18px; text-align: center;"><span style="font-weight: bold"><b>Interpretation of Results</b></span></td>                
            </tr>
            <tr>
                <td colspan="8" style="font-size: 13px;"><span style="font-weight: bold">Negative: </span><span>It means there is no viral Nucleic acid (DNA or free proviral RNA) detected</span></td>
            </tr>
            <tr>
                <td colspan="8"style="font-size: 13px;"><span style="font-weight: bold">Positive: </span><span>It means viral DNA or free proviral RNA was detected</span></td>
            </tr>
<?php }
?>
    </table>
