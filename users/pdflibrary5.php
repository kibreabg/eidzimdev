...
function Footer()
{
	...
	$this->SetFont('Arial','I',8);		// Arial italic 8
		$this->Cell(100,14,'Wines of the World ',o,0,'C');	// Title
			$this->Ln(4);		
		$this->Cell(100,14,'Email: wines@wines.co.ke Telephone: +254 020 4343440/5 or 4347382 ',o,0,'C');	// Title

	//$this->Image('images/wines.jpg',8,7,49);	// Logo
