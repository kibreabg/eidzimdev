...
$labss = $_SESSION['lab'];
$rejected=weeklyrejectedsamples($labss,$weekstartdate,$weekenddate);
...
$this->Image('../img/kemrilogo.jpg',140,9);	// Logo
	...
	$this->Ln(39);	
 	...
 	//$this->SetTextColor(204,204,204);
			...
			$this->Cell(140,10,sprintf("SUMMARY OF TESTS DONE BETWEEN ". $weekstartdatee . " & ".$weekenddatee),0,0,'C');	// Title
...
$title= $weekstartdatee." - ".$weekenddatee ." TESTS SUMMARY REPORT ".".pdf";
$F="I";
$pdf->Output($title,$F);?>
?>