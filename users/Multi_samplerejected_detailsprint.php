...
<html><!---->
    <body onLoad="JavaScript:window.print();">
      ...
      <td bgcolor="#F0F3FA"><?php /*
          ...
          echo $pAge.$agetype; */ ?></td>
            ...
            <th style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">Entry Point</th><td><?php echo $entry; ?></td><th style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">Reasons for TNA / PCR Test</th><td colspan="3" ><?php
                $test_reason = GetTestReason($test_reason);
                echo $test_reason;
                ?></td>
            <tr>
                <th style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2">Rejected Reason</th>
                <td>
                    <?php
    ...
    <td><span style="font-weight: bold">No of Spots </span></td>
			...
			") or die(mysql_error());
                ...
                <tr><td>&nbsp;</td></tr><tr><td colspan="2"><span style="font-weight: bold">Dispatch Comments: DBS SAMPLE VALID</span></td><td><?php echo $DispatchComments; ?></td> <td colspan="2"><span style="font-weight: bold">Platform:  </span></td><td> Roche Ampliprep</td></tr><tr><td>&nbsp;</td>  </tr>
