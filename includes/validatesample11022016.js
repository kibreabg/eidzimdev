...
$(document).ready(function(){
    ...
    addonly.click(function(){
        if( validaterequestno_no() & validaterequestno_year() & validatedelivery() & validateMbfeeding() & validateDatecollected() & validateDateReceived() & validateDatecollected() & validateMentpoint() & validateTestReason() & validatenmrlstampno() & validateRejectedReason() & validateResult())
        {
            $("#addOnlyInd").val("true");
            form.submit();
            return true;
    ...
    saveadd.click(function(){
        if( validaterequestno_no() & validaterequestno_year() & validatedelivery() & validateMbfeeding() & validateDatecollected() & validateDateReceived() & validatenmrlstampno() & validateDatecollected() & validateMentpoint() & validateTestReason() & validateRejectedReason() & validateResult())
        {
            $("#addSaveInd").val("true");
            form.submit();
            return true;
